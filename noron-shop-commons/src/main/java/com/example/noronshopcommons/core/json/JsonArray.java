...
public class JsonArray implements Iterable<Object> {
     ...
     */
    public com.example.noronshopcommons.core.json.JsonObject getJsonObject(int pos) {
        Object val = list.get(pos);
        if (val instanceof Map) {
            val = new com.example.noronshopcommons.core.json.JsonObject((Map) val);
        }
        return (com.example.noronshopcommons.core.json.JsonObject) val;
    }
     ...
     * @return a reference to this, so the API can be used fluently
     */
    public JsonArray add(com.example.noronshopcommons.core.json.JsonObject value) {
        Objects.requireNonNull(value);
        list.add(value);
        return this;
    }
     ...
     * @return the removed value if removed, null otherwise. If the value is a Map, a {@link com.example.noronshopcommons.core.json.JsonObject} is built from
    ...
    public Object remove(int pos) {
        ...
        if (removed instanceof Map) {
            return new com.example.noronshopcommons.core.json.JsonObject((Map) removed);
    ...
    public String encode() {
        return com.example.noronshopcommons.core.json.Json.encode(list);
    }
    ...
    public Stream<Object> stream() {
        return com.example.noronshopcommons.core.json.Json.asStream(iterator());
    }
}
