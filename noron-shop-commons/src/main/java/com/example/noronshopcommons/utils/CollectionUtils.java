...
public class CollectionUtils {
    ...
    public static <T> List<T> getOrDefaultList(Class<T> tClass, JSON json, List<T> list) {
        if (json == null || json.data() == null) return list;
        return new JsonArray(json.data()).mapTo(tClass);
    }
}
